...
class SignupViewController: UIViewController {
    ...
    // MARK: initialiging Global workitem
    ...
    func checkUsernameAvailability(username: String) {
        ...
        //MARK: Makking it cancellable  ( suppose you hit api , and its calling and you agin hit so previus one is canceed and the current one is on the queue)
        ...
        // MARK: Storing local workitem into global
        usernameAvailabilityWorkItem = workItem
        
        // MARK: Setting delay of 1 secound 
...
extension SignupViewController: UITextFieldDelegate {
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if textField == usernameTextField {
            ...
            //MARK: Making Api call for searching username in db
